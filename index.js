 ...
 */
export const handleApiError = (err, { callBackStatusCode, showAlert = true, callBackErrorMessage } = {}) => {
 ...
 * @param {*} isLoading 
 */
export const setShowLoading = (dispatch, isLoading) => {
  if (typeof dispatch === 'function') {
    dispatch({type: 'LOADING', payload: isLoading});
  }
}

export const makeQueryParamsFromObject = params => {
  let result = '', keys = [];
